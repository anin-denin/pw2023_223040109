...
include 'components/add_cart.php'; // Memasukkan file add_cart.php untuk menangani fungsi tambah ke keranjang
...
<section class="quick-view">
    ...
    <?php
    $pid = $_GET['pid']; // Mengambil nilai pid dari parameter GET
    $select_products = $conn->prepare("SELECT * FROM `products` WHERE id = ?"); // Mengambil produk dengan id yang sesuai
